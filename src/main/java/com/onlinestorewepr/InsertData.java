...
public class InsertData {
    public static void main(String[] args) {
        ...
        Seller seller1 = new Seller("Hua", null, 1, user);
        ...
        Product c1p1 = new Product(
                ...
                159.0, 100, 0.0, "XL", "Grey", "BEAMS PLUS", true, category1, seller1);
        ...
        Product c1p2 = new Product(
                ...
                259.0, 100, 0.0, "M", "Orange", "VINTAGE HEAVY", true, category1, seller1);
        Product c1p3 = new Product(
                ...
                "Color : Fuchsia\n" +
                        ...
                        "Made in USA\n" +
                        "Model is 6'3 wearing a size M",
                225.0, 100, 0.0, "XL", "Fuchsia", "BEAMS PLUS", true, category1, seller1);
        ...
        Product c2p1 = new Product(
                ...
                240.00, 100, 150.0, "XL", "Greencast Indigo", "BEAMS PLUS", true, category2, seller1);
        ...
        Product c2p2 = new Product(
                ...
                304.00, 100, 0.0, "XL", "Beige", "KAPITAL", true, category2, seller1);
        ...
        Product c3p1 = new Product(
                ...
                "Color: Natural Indigo (Hank Dyed) x Kakishibu (Persimmon)\n" +
                        ...
                        "100% cotton\n" +
                        "Made In Japan",
                815.00, 100, 700.0, "XL", "Blue", "KAPITAL", true, category3, seller1);
        ...
        Product c3p2 = new Product(
                ...
                298.00, 100, 0.0, "M", "Ecru", "KAPITAL", true, category3, seller1);
        Product c3p3 = new Product(
                ...
                330.00, 100, 0.0, "M", "Faded Black", "KAPITAL", true, category3, seller1);
        ...
        Product c4p1 = new Product(
                ...
                93.00, 100, 0.0, "M", "UP Work JKT", "KAPITAL", true, category4, seller1);
        Product c4p2 = new Product(
                ...
                "Color: No.9+S/ Mud\n" +
                        ...
                        "Made in Japan\n" +
                        "Model is 6'3\" wearing size 4",
                798.00, 100, 0.0, "XL", "Black", "KAPITAL", true, category4, seller1);
