...
public class InsertData {
  public static void main(String[] args) {
    ...
    Product c1p2 = new Product(
        ...
        259.0, 100, 0.0, "M", "Orange", "VINTAGE HEAVY", true, category1);
    ...
    Product c3p2 = new Product(
        ...
        298.00, 100, 0.0, "M", "Ecru", "KAPITAL", true, category3);
    Product c3p3 = new Product(
        ...
        330.00, 100, 0.0, "M", "Faded Black", "KAPITAL", true, category3);
    ...
    Product c4p1 = new Product(
        ...
        93.00, 100, 0.0, "M", "UP Work JKT", "KAPITAL", true, category4);
