                        ...
                        <div class="col-md-12">
                            <div class="card mb-4">
                                    ...
                                    <div class="d-flex align-items-center align-items-sm-center gap-4"
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise><img
                                                    ...
                                                    alt="Seller" class="rounded-circle"
                                                    width="150">
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="basic-default-name">Shop
                                                name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="" value="${sessionScope.userLogged.username}_shop"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <span class="form-control">${sessionScope.userLogged.username}</span>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
